...
def run(img, subj_group, stream, assessment, sheetn, tf_interpreter, base_i):
  ...
  result_loc = write_results.write(student_filled_box, result_ml, subj_group, stream, assessment, sheetn, base_i)
